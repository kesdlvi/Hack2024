...
const randomize = () => {
    ...
    <>
        ...
        <div className='top-region'>
            <button className= {"btn btn-shadow-drop btn-shadow-drop--black"}><img className='all' width = "680" src="https://t4.ftcdn.net/jpg/03/06/49/25/360_F_306492512_Cnv1Ie8ZZ1qWMhtFJAupzafY9DGf5Bi8.jpg" alt="" /></button>
        </div>
        <div className='names'>
        <h2>Africa</h2>
